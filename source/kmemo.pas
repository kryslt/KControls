...
var
  Dummy: Integer;
begin
  Result := ActiveBlocks.IndexToBlocks(ActiveBlocks.RealSelEnd, Dummy);
end;
...
begin
  ...
  if Block >= 0 then
    Result := ActiveBlocks.GetNearestParagraph(Block)
  else
    Result := nil;
end;
...
begin
  ...
  begin
    if FSelectedBlock.SelLength > 0 then
...
begin
  ...
  begin
    ActiveBlocks := AItem.ParentBlocks;
