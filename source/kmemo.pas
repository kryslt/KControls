...
begin
  ...
  begin
    ...
    DeltaHorz := ClientHorz + FLeftPos - FHorzExtent - 1;
    if DeltaHorz > 0 then
      Dec(FLeftPos, DeltaHorz)
    else
      DeltaHorz := 0;
    DeltaVert := ClientVert + FTopPos - FVertExtent - 1;
    if DeltaVert > 0 then
      Dec(FTopPos, DeltaVert)
    else
      DeltaVert := 0;
    FHorzScrollExtent := 0;
    FVertScrollExtent := 0;
...
begin
  ...
  try
    ...
    while I < Count do
    begin
      if Items[I].ContentLength = 0 then
        Delete(I)
      else
        Inc(I);
    end;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          if InsertString(AIndex, False, S) then
