...
{$ENDIF}
  ...
  { @abstract(Metaclass for @link(TKGridColors)) This type is used in the
    @link(TKCustomGrid.ColorsClass) property. }
...
*)
  ...
  {$ENDIF}
    ...
    property ColorsClass: TKGridColorsClass read GetColorsClass;
...
{$ENDIF}
  ...
  FColors := ColorsClass.Create(Self);
